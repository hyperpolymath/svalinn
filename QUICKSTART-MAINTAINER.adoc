...
// Replace svalinn, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= svalinn — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining svalinn for
...
* Upstream: https://github.com/hyperpolymath/svalinn/issues
