...
// Replace svalinn, Svalinn — See README.adoc for details., just run, Svalinn started successfully. with actuals
= svalinn — Quick Start for Users
:toc:
:toclevels: 2

== What is svalinn?

Svalinn — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./svalinn-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/svalinn/wiki
